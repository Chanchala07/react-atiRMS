      ...
      <div className='content-wraper'>
        ...
        <div className='row'>
          <div className='col-md-12 col-lg-12'>
            <div className='panel'>
              <DataTable value={archiveEmployeeListData}
                paginator
                showGridlines
                rows={10}
                header={header}
                ...
                <Column
                  ...
                  body={(rowData) =>
                    <ExpandableText content={rowData.Name} maxLength={20} />
                  } />
                ...
                <Column
                  ...
                  body={(rowData) =>
                    <ExpandableText content={rowData.TitleRole} maxLength={20} />
                  } />
                ...
                <Column
                  header="Firm Name and Location (city and state)"
                  field='CompanyLocation'
                  sortable
                  className='width_desc'
                  body={(rowData) =>
                    <ExpandableText content={rowData.CompanyLocation} maxLength={20} />} />

                <Column
                  header="Education/Degrees"
                  field='Education'
                  sortable
                  className='width_desc'
                  body={(rowData) =>
                    <ExpandableText content={rowData.Education} maxLength={20} />} />

                <Column
                  header="Certifications and Licenses"
                  field='CertificatesLicenses'
                  sortable
                  className='width_desc'
                  body={(rowData) =>
                    <ExpandableText content={rowData.CertificatesLicenses} maxLength={20} />} />

                <Column
                  header="Other Professional Qualifications"
                  field='OtherQualification'
                  sortable
                  className='width_desc'
                  body={(rowData) =>
                    <ExpandableText content={rowData.OtherQualification} maxLength={20} />} />
