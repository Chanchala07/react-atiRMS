          ...
          <div className='col-md-12 col-lg-12'>
            <div className='panel'>
              <div className='panel-body'>
                <DataTable value={employeeListData}
                  paginator
                  showGridlines
                  rows={10}
                  header={header}
                  ...
                  <Column
                    ...
                    body={(rowData: Employee) => (
                      <Link
                        ...
                        className="btn btn-view bg-blue"
                        style={{ minWidth: "90px" }}
                      >
                        View or Edit
                      </Link>
                  ...
                  <Column header="Name"
                    field='Name'
                    sortable
                    className='width_desc_name'
                    body={(rowData) =>
                      <ExpandableText content={rowData.Name} maxLength={30} />
                    } />

                  <Column header="Title/Role"
                    field='TitleRole'
                    sortable
                    className='width_desc'
                    body={(rowData) =>
                      <ExpandableText content={rowData.TitleRole} maxLength={30} />
                    } />
                  ...
                  <Column header="Years of Experience"
                    ...
                    sortable
                    body={(rowData) =>
                      calculateYearExperience(rowData, 'WorkStartYear', 'WorkEndYear', 'WorkEndPresent')} />

                  <Column header="Years with Employer"
                    field=''
                    sortable
                    body={(rowData) =>
                      calculateYearExperience(rowData, 'ATIStartYear', 'ATIEndYear', 'ATiEndPresent')} />

                  <Column header="Firm Name and Location (city and state)"
                    sortable
                    field='CompanyLocation'
                    className='width_desc'
                    body={(rowData) =>
                      <ExpandableText content={rowData.CompanyLocation} maxLength={30} />
                    } />

                  <Column header="Education/Degrees"
                    field='Education'
                    sortable
                    className='width_desc'
                    body={(rowData) =>
                      <ExpandableText content={rowData.Education} maxLength={30} />
                    } />

                  <Column header="Certifications and Licenses"
                    field='CertificatesLicenses'
                    sortable
                    className='width_desc'
                    body={(rowData) => <ExpandableText content={rowData.CertificatesLicenses} maxLength={30} />
                    } />

                  <Column header="Other Professional Qualifications"
                    field='OtherQualification'
                    sortable
                    className='width_desc'
                    body={(rowData) => <ExpandableText content={rowData.OtherQualification} maxLength={30} />
                    } />

                  <Column header="Career Start Year"
                    field='WorkStartYear'
                    sortable
                    body={(rowData) => formateDate(rowData.WorkStartYear)} />

                  <Column header="Career End Year"
                    field='WorkEndYear'
                    sortable
                    body={(rowData) => dateOngoing(rowData, 'WorkEndPresent', 'WorkEndYear')} />

                  <Column header="ATI/DGI Start Year"
                    field='ATIStartYear'
                    sortable
                    body={(rowData) => formateDate(rowData.ATIStartYear)} />

                  <Column header="ATI/DGI End Year"
                    field='ATIEndYear'
                    sortable
